...
function generateHiitAccessoryWorkout(){
  ...
  while (accessoryWorkoutCount < 10){
    ...
    const randomCategory = hiitAccessories[Math.floor(Math.random() * hiitAccessories.length)];
    const randomHiitAccessories = randomCategory[Math.floor(Math.random() * randomCategory.length)];
